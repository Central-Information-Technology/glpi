...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["firstlevel"]) {
            ...
            // line 42
            echo "   ";
            if (twig_get_attribute($this->env, $this->source, $context["firstlevel"], "content", [], "array", true, true, false, 42)) {
                // line 43
                echo "      ";
                // line 44
                echo "      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["secondlevel"]) {
                    // line 45
                    echo "         ";
                    if (twig_get_attribute($this->env, $this->source, $context["secondlevel"], "page", [], "array", true, true, false, 45)) {
                        // line 46
                        echo "            ";
      ...
      <a class=\"nav-link dropdown-toggle ";
         ...
         <i class=\"fa-fw ";
                // line 56
                (((twig_get_attribute($this->env, $this->source, $context["firstlevel"], "icon", [], "array", true, true, false, 56) &&  !(null === (($__internal_compile_8 = $context["firstlevel"]) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["icon"] ?? null) : null)))) ? (print (twig_escape_filter($this->env, (($__internal_compile_9 = $context["firstlevel"]) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["icon"] ?? null) : null), "html", null, true))) : (print ("")));
                echo "\"></i>
      ...
      <div class=\"dropdown-menu ";
         ...
         <div class=\"dropdown-menu-columns\">
            ...
            ";
                // line 63
                $context["has_dashboard"] = twig_get_attribute($this->env, $this->source, $context["firstlevel"], "default_dashboard", [], "array", true, true, false, 63);
                // line 64
                echo "            ";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["sublevel"]) {
                    // line 72
                    echo "               ";
                    if (twig_get_attribute($this->env, $this->source, $context["sublevel"], "page", [], "array", true, true, false, 72)) {
                        // line 73
                        echo "               <a class=\"dropdown-item ";
                  ...
                  accesskey=\"";
                        // line 75
                        (((twig_get_attribute($this->env, $this->source, $context["sublevel"], "shortcut", [], "array", true, true, false, 75) &&  !(null === (($__internal_compile_16 = $context["sublevel"]) && is_array($__internal_compile_16) || $__internal_compile_16 instanceof ArrayAccess ? ($__internal_compile_16["shortcut"] ?? null) : null)))) ? (print (twig_escape_filter($this->env, (($__internal_compile_17 = $context["sublevel"]) && is_array($__internal_compile_17) || $__internal_compile_17 instanceof ArrayAccess ? ($__internal_compile_17["shortcut"] ?? null) : null), "html", null, true))) : (print ("")));
                        echo "\" title=\"";
                  ...
                  <i class=\"fa-fw ";
                        // line 76
                        (((twig_get_attribute($this->env, $this->source, $context["sublevel"], "icon", [], "array", true, true, false, 76) &&  !(null === (($__internal_compile_19 = $context["sublevel"]) && is_array($__internal_compile_19) || $__internal_compile_19 instanceof ArrayAccess ? ($__internal_compile_19["icon"] ?? null) : null)))) ? (print (twig_escape_filter($this->env, (($__internal_compile_20 = $context["sublevel"]) && is_array($__internal_compile_20) || $__internal_compile_20 instanceof ArrayAccess ? ($__internal_compile_20["icon"] ?? null) : null), "html", null, true))) : (print ("")));
                        echo "\"></i>
                  <span class='text-wrap'>
                     ";
                        // line 78
                        echo $this->extensions['Glpi\Application\View\Extension\DataHelpersExtension']->underlineShortcutLetter((($__internal_compile_21 = $context["sublevel"]) && is_array($__internal_compile_21) || $__internal_compile_21 instanceof ArrayAccess ? ($__internal_compile_21["title"] ?? null) : null), (((twig_get_attribute($this->env, $this->source, $context["sublevel"], "shortcut", [], "array", true, true, false, 78) &&  !(null === (($__internal_compile_22 = $context["sublevel"]) && is_array($__internal_compile_22) || $__internal_compile_22 instanceof ArrayAccess ? ($__internal_compile_22["shortcut"] ?? null) : null)))) ? ((($__internal_compile_23 = $context["sublevel"]) && is_array($__internal_compile_23) || $__internal_compile_23 instanceof ArrayAccess ? ($__internal_compile_23["shortcut"] ?? null) : null)) : ("")));
                        echo "
                  </span>
               </a>
               ";
               ...
               ";
                    ...
                    // line 84
                    echo "               ";
                    if ((((twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 84) % ($context["count_per_column"] ?? null)) == ((($context["has_dashboard"] ?? null)) ? ((($context["count_per_column"] ?? null) - 1)) : (0))) &&  !twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 84))) {
                        // line 85
                        echo "                  </div>
                  <div class=\"dropdown-menu-column\">
               ";
...
$context["firstlevel"], "default", [], "array", true, true, false, 93) && ((((twig_get_attribute($this->env, $this->source, $context["firstlevel"], "display", [], "array", true, true, false, 93) &&  !(null === (($__internal_compile_24 = $context["firstlevel"]) && is_array($__internal_compile_24) || $__internal_compile_24 instanceof ArrayAccess ? ($__internal_compile_24["display"] ?? null) : null)))) ? ((($__internal_compile_25 = $context["firstlevel"]) && is_array($__internal_compile_25) || $__internal_compile_25 instanceof ArrayAccess ? ($__internal_compile_25["display"] ?? null) : null)) : (true)) != false))) {
                // line 94
                echo "      <li class=\"nav-item dropdown ";
                echo ((($context["firstlevel_active"] ?? null)) ? ("active") : (""));
...
";
    ...
    {
        return array (  325 => 136,  321 => 135,  317 => 134,  303 => 123,  293 => 116,  283 => 109,  278 => 106,  276 => 105,  272 => 103,  261 => 98,  257 => 97,  253 => 96,  249 => 95,  244 => 94,  242 => 93,  236 => 89,  222 => 88,  217 => 85,  214 => 84,  212 => 83,  209 => 82,  202 => 78,  197 => 76,  191 => 75,  187 => 74,  182 => 73,  179 => 72,  161 => 71,  155 => 68,  150 => 66,  147 => 65,  144 => 64,  142 => 63,  136 => 60,  128 => 59,  123 => 57,  119 => 56,  115 => 55,  108 => 53,  104 => 52,  99 => 51,  96 => 50,  93 => 49,  87 => 48,  84 => 47,  81 => 46,  78 => 45,  73 => 44,  71 => 43,  68 => 42,  65 => 41,  62 => 40,  59 => 39,  55 => 38,  51 => 37,  48 => 36,  46 => 35,  44 => 34,  42 => 33,  40 => 32,  37 => 31,);
    }
