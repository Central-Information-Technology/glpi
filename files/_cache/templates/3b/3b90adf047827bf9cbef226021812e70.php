...
($context["params"] ?? null)) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["locations_id"] ?? null) : null), $this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeName("Location"), twig_array_merge(        // line 217
($context["right_field_options"] ?? null), ["hide_if_no_elements" => true])], 212, $context, $this->getSourceContext());
        // line 220
        echo "

               ";
        // line 222
        echo twig_call_macro($macros["fields"], "macro_textField", ["name", (($__internal_compile_11 =         // line 224
($context["params"] ?? null)) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["name"] ?? null) : null), __("Title"),         // line 226
($context["right_field_options"] ?? null)], 222, $context, $this->getSourceContext());
        // line 227
        echo "

               ";
        // line 229
        echo twig_call_macro($macros["fields"], "macro_textareaField", ["content", (($__internal_compile_12 =         // line 231
($context["params"] ?? null)) && is_array($__internal_compile_12) || $__internal_compile_12 instanceof ArrayAccess ? ($__internal_compile_12["content"] ?? null) : null), __("Description"), twig_array_merge(        // line 233
($context["right_field_options"] ?? null), ["enable_richtext" => true, "enable_fileupload" => true])], 229, $context, $this->getSourceContext());
        // line 237
        echo "
            </div>
        </div>
